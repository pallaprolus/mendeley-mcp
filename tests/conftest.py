...
@pytest.fixture
def folder_assignment_documents():
    """Sample folder-membership listing returned by the API."""
    return [
        {"id": "other-doc-id"},
        {"id": "third-doc-id"},
    ]
...
@pytest.fixture
def duplicate_folder_assignment_documents(sample_document_data):
    """Folder-membership listing that already contains the target document."""
    return [
        {"id": "other-doc-id"},
